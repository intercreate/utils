 ...
 */
#define _IC_Z_Z_IS_ENABLED1(config_macro) Z_IS_ENABLED2(_XXXX##config_macro)
 ...
 */
#define _IC_Z_Z_IS_ENABLED2(one_or_two_args) Z_IS_ENABLED3(one_or_two_args 1, 0)
 ...
 */
#define _IC_Z_Z_IS_EQ(_0, _1) Z_HAS_COMMA(Z_CAT4(Z_IS_, _0, _EQ_, _1)())
...
#define _IC_Z_Z_LIST_DROP_FIRST(...) GET_ARGS_LESS_N(1, __VA_ARGS__)
#define _IC_Z_Z_LIST_NO_EMPTIES(e) \
	COND_CODE_1(IS_EMPTY(e), (), (Z_LIST_ADD_ELEM(e)))

#define _IC_Z_UTIL_CAT(a, ...) UTIL_PRIMITIVE_CAT(a, __VA_ARGS__)
#define _IC_Z_UTIL_PRIMITIVE_CAT(a, ...) a##__VA_ARGS__
#define _IC_Z_UTIL_CHECK_N(x, n, ...) n
#define _IC_Z_UTIL_CHECK(...) UTIL_CHECK_N(__VA_ARGS__, 0,)
#define _IC_Z_UTIL_NOT(x) UTIL_CHECK(UTIL_PRIMITIVE_CAT(UTIL_NOT_, x))
#define _IC_Z_UTIL_NOT_0 ~, 1,
#define _IC_Z_UTIL_COMPL(b) UTIL_PRIMITIVE_CAT(UTIL_COMPL_, b)
#define _IC_Z_UTIL_COMPL_0 1
#define _IC_Z_UTIL_COMPL_1 0
#define _IC_Z_UTIL_BOOL(x) UTIL_COMPL(UTIL_NOT(x))

#define _IC_Z_UTIL_EVAL(...) __VA_ARGS__
#define _IC_Z_UTIL_EXPAND(...) __VA_ARGS__
#define _IC_Z_UTIL_REPEAT(...) UTIL_LISTIFY(__VA_ARGS__)
...
#define _IC_Z_MACRO_MAP_CAT_N_(N, ...) UTIL_CAT(MACRO_MC_, N)(__VA_ARGS__,)
#define _IC_Z_MACRO_MC_0(...)
#define _IC_Z_MACRO_MC_1(m, a, ...)  m(a)
#define _IC_Z_MACRO_MC_2(m, a, ...)  UTIL_CAT(m(a), MACRO_MC_1(m, __VA_ARGS__,))
#define _IC_Z_MACRO_MC_3(m, a, ...)  UTIL_CAT(m(a), MACRO_MC_2(m, __VA_ARGS__,))
#define _IC_Z_MACRO_MC_4(m, a, ...)  UTIL_CAT(m(a), MACRO_MC_3(m, __VA_ARGS__,))
#define _IC_Z_MACRO_MC_5(m, a, ...)  UTIL_CAT(m(a), MACRO_MC_4(m, __VA_ARGS__,))
#define _IC_Z_MACRO_MC_6(m, a, ...)  UTIL_CAT(m(a), MACRO_MC_5(m, __VA_ARGS__,))
#define _IC_Z_MACRO_MC_7(m, a, ...)  UTIL_CAT(m(a), MACRO_MC_6(m, __VA_ARGS__,))
#define _IC_Z_MACRO_MC_8(m, a, ...)  UTIL_CAT(m(a), MACRO_MC_7(m, __VA_ARGS__,))
#define _IC_Z_MACRO_MC_9(m, a, ...)  UTIL_CAT(m(a), MACRO_MC_8(m, __VA_ARGS__,))
#define _IC_Z_MACRO_MC_10(m, a, ...) UTIL_CAT(m(a), MACRO_MC_9(m, __VA_ARGS__,))
#define _IC_Z_MACRO_MC_11(m, a, ...) UTIL_CAT(m(a), MACRO_MC_10(m, __VA_ARGS__,))
#define _IC_Z_MACRO_MC_12(m, a, ...) UTIL_CAT(m(a), MACRO_MC_11(m, __VA_ARGS__,))
#define _IC_Z_MACRO_MC_13(m, a, ...) UTIL_CAT(m(a), MACRO_MC_12(m, __VA_ARGS__,))
#define _IC_Z_MACRO_MC_14(m, a, ...) UTIL_CAT(m(a), MACRO_MC_13(m, __VA_ARGS__,))
#define _IC_Z_MACRO_MC_15(m, a, ...) UTIL_CAT(m(a), MACRO_MC_14(m, __VA_ARGS__,))
