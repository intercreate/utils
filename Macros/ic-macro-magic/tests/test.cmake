...
execute_process(COMMAND cmake "-Bbuild" RESULT_VARIABLE res)
if(NOT ${res} STREQUAL "0")
    message(FATAL_ERROR "CMake configuration step failed.")
endif()

execute_process(COMMAND cmake "--build" "build" "--clean-first" RESULT_VARIABLE res)
if(NOT ${res} STREQUAL "0")
    message(FATAL_ERROR "CMake build step failed.")
endif()

execute_process(COMMAND ctest "-V" "--test-dir" "build" RESULT_VARIABLE res)
if(NOT ${res} STREQUAL "0")
